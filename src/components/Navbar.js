...
const Navbar = ({
  ...
  const handleLinkChange = () => {
    const bars = document.getElementById("header-shown");
    const close = document.getElementById("header-hidden");
        ...
        <div className="menu-container menu-row">
          ...
          <div className="menu">
            <ul className="menu-items menu-no-sides">
              ...
              <li htmlFor="header-hidden">
                <Link to="/services" onClick={handleLinkChange}>
                  Services
                </Link>
              </li>

              <li htmlFor="header-hidden">
                <Link to="/about-us" onClick={handleLinkChange}>
                  About us
                </Link>
              </li>
              ...
              {!isLoggedIn ? (
                <li>
                  <Link to="/sign-in" onClick={handleLinkChange}>
                    Sign In
                  </Link>
                </li>
              ) : (
              ...
              {isLoggedIn ? (
                <li>
                  <Link to="/dashboard" onClick={handleLinkChange}>
                    Dashboard
                  </Link>
                </li>
              ) : (
